jQuery(document).ready(function($) {
  ...
  $("body").on("submit", ".form form", function(e) {
    ...
    Email.send({
      ...
      Username: "hungqs2195@gmail.com",
      Password: "6174E4A9376511BC705C5590A670E04B694B",
      To: 'vodinhhung2195@gmail.com',
      From: "hungqs2195@gmail.com",
      Subject: "Test email",
      Body: "会社名:"+ name_company + "<br>氏名: " + name + "<br>メールアドレス: " + email + "<br>お問い合わせ: " + content + ""
    }).then(
